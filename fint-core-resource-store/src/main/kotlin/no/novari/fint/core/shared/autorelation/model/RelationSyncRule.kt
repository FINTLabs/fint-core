...
data class RelationSyncRule(
    ...
    private fun FintMultiplicity.isToOne(): Boolean = this == FintMultiplicity.ONE_TO_ONE || this == FintMultiplicity.NONE_TO_ONE

    private fun FintMultiplicity.isToMany(): Boolean = this == FintMultiplicity.ONE_TO_MANY || this == FintMultiplicity.NONE_TO_MANY
}
