 ...
 * [no.novari.fint.core.shared.autorelation.MetricService] instead, since one consumed record fans out to
...
class KafkaThroughputMetrics(
     ...
     * [no.novari.fint.core.shared.autorelation.AutoRelationService]), so a single record-level
     * success/failed tag would be misleading. Per-target outcomes live in
     * [no.novari.fint.core.shared.autorelation.MetricService].
     */
