# Fint Core Client API

![Build Status](https://img.shields.io/badge/build-passing-brightgreen) ![Version](https://img.shields.io/badge/version-1.0.0-blue)

**Fint Core Client API** streamlines and unifies existing consumer projects into a single, cohesive solution. It allows you to manage and modify consumer behavior through configuration, removing the need to maintain multiple separate consumers.
