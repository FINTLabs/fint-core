...
class PersistanseIT(
    ...
    /**
     * Adapters post JSON, so SyncPageEntry.resource always holds a map by the time it reaches the
     * buffer. Building an Elev here instead would exercise a path production never takes.
     */
