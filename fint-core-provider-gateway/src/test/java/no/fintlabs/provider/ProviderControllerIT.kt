            ...
            val syncPage =
                FullSyncPage().apply {
                    this.metadata =
                        SyncPageMetadata
                            .builder()
                            .adapterId(this@ProviderControllerIT.adapterId)
                            .orgId(this@ProviderControllerIT.orgId)
        ...
        fun `Should successfully register adapter and perform fullSync`() {
            val capability =
                AdapterCapability().apply {
                    this.domainName = this@ProviderControllerIT.domainName
                    this.packageName = this@ProviderControllerIT.packageName
                    this.resourceName = this@ProviderControllerIT.resourceName
            ...
            val adapterContract =
                AdapterContract().apply {
                    this.adapterId = this@ProviderControllerIT.adapterId
                    this.orgId = this@ProviderControllerIT.orgId
                    this.username = this@ProviderControllerIT.username
