package no.novari.fint.core.provider.security;

import no.novari.resource.server.authentication.CorePrincipal;
import no.novari.fint.core.provider.exception.InvalidOrgId;
import no.novari.fint.core.provider.exception.InvalidUsername;
import no.novari.fint.core.provider.register.ContractJpaRepository;
import no.novari.fint.core.provider.register.ContractService;
