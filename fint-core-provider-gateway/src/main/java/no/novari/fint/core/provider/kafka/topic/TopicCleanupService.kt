...
import no.novari.fint.core.provider.kafka.topic.TopicNamesConstants.ADAPTER_REGISTER_EVENT_NAME
import no.novari.fint.core.provider.kafka.topic.TopicNamesConstants.CONSUMER_ERROR_EVENT_NAME
import no.novari.fint.core.provider.kafka.topic.TopicNamesConstants.FINT_CORE
